...
procedure T_WWBstr_Slice_02 is
...
begin
  ...
  begin
    Test.Check (TC, 2279, BS.To_String (BSS) = "AB", "BS.To_String (BSS) = ""AB""");
  end;

  declare
    BSS : constant BS.Bounded_String := BS.Bounded_Slice (S1, 1, 4);
  begin
    Test.Check (TC, 2280, BS.To_String (BSS) = "ABCD", "BS.To_String (BSS) = ""ABCD""");
  end;

  declare
    BSS : constant BS.Bounded_String := BS.Bounded_Slice (S1, 2, 3);
  begin
    Test.Check (TC, 2281, BS.To_String (BSS) = "BC", "BS.To_String (BSS) = ""BC""");
  end;
  ...
  Test.Check (TC, 2282, Error, "Error");

end T_WWBstr_Slice_02;
